...
class MY_Zend
{
    ...
    function __construct($class = NULL)
    {
        ...
        ini_set('include_path',
            ini_get('include_path') . PATH_SEPARATOR . APPPATH . SPARKS_DIR . SPARK_NAME . PATH_SLASH . ZEND_LIB_VERSION . '/libraries');

        if ($class)
        {
            require_once (string) ZEND_LIB . $class . EXT;
